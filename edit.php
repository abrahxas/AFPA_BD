...
<div id="content">
	...
	<?php
$requete="SELECT * FROM `produit` WHERE ID_BD=$_GET[id]";
$result=mysql_query($requete);
$sql=mysql_fetch_array($result);
?>
<form action='traitement.php' name='edit'>
	<table>
	<tr><td>Ref BD</td><td><input type='text' name='REF_BD' value='<?php echo "$sql[REF_BD]"; ?>'></td></tr>
	<tr><td>Hero</td><td><input type='text' name='HERO'value='<?php echo "$sql[HEROS]"; ?>'></td></tr>
	<tr><td>Titre</td><td><input type='text' name='TITRE'value='<?php echo "$sql[TITRE]"; ?>'></td></tr>
	<tr><td>Prix Public</td><td><input type='text' name='PRIX_PUBLIC'value='<?php echo "$sql[PRIX_PUBLIC]"; ?>'></td></tr>
	<tr><td>Prix Editeur</td><td><input type='text' name='PRIX_EDITEUR'value='<?php echo "$sql[PRIX_EDITEUR]"; ?>'></td></tr>
	...
	<tr><td>Resume</td><td><textarea name='RESUME'><?php echo "$sql[RESUME]"; ?></textarea></td></tr>
	<tr><td>Ref Fournisseur</td><td><input type='text' name='REF_FOURNISSEUR'value='<?php echo "$sql[REF_FOURNISSEUR]"; ?>'></td></tr>
	<tr><td>Ref Editeur</td><td><input type='text' name='REF_EDITEUR'value='<?php echo "$sql[REF_EDITEUR]"; ?>'></td></tr>
	</table>
